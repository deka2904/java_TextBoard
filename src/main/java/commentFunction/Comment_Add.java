...
public class Comment_Add {
    ...
    public void commentadd(int num, String nickname){
        ...
        try {
            ...
            String commentQuery = "INSERT INTO text_board_comment (comment, comment_time, board_number, comment_member_nickname) VALUES (?, NOW(), ?, ?)";
            ...
            commentStatement.setString(3, comment_member_nickname);
            ...
            String selectContentsQuery = "SELECT * FROM text_board LEFT JOIN text_board_comment ON text_board.number = text_board_comment.board_number WHERE text_board.number = ?";
            ...
            if (resultSet.next()) {
                ...
                do {
                    ...
                    comment_member_nickname = resultSet.getString("comment_member_nickname");
